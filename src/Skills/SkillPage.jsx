...
const SkillPage = () => {
    return (
        <>
                ...
                <div>
                    ...
                    <div className="flex flex-col w-[280px] sm:w-96 mx-auto cursor-pointer my-3">
                        <div className="flex">
                            ...
                            <h1 className="text-[#808dad68] hover:text-white relative left-[30px] sm:left-[230px]">80%</h1>
                        </div>
                        <div className="border-2 border-[#5e76be] h-[9px] sm:h-[10px] rounded-lg w-[280px]  sm:w-96">
                            <div className="sm:h-[8px] h-[6px] w-[175px] bg-[#02C56D] rounded-lg sm:w-72">
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col w-[280px] sm:w-96 mx-auto cursor-pointer my-3">
                        <div className="flex">
                            ...
                            <h1 className="text-[#808dad68] hover:text-white relative left-[80px] sm:left-[230px]">75%</h1>
                        </div>
                        <div className="border-2 border-[#5e76be] h-[9px] sm:h-[10px] rounded-lg w-[280px]  sm:w-96">
                            <div className="sm:h-[8px] h-[6px] w-[150px] bg-[#02C56D] rounded-lg sm:w-72">
                            </div>
                        </div>
                    </div>
                </div>
                <div>
                    <div className="flex flex-col w-[280px] sm:w-96 mx-auto cursor-pointer my-3">
                        <div className="flex">
                            ...
                            <h1 className="text-[#808dad68] hover:text-white relative left-[85px] sm:left-[230px]">75%</h1>
                        </div>
                        <div className="border-2 border-[#5e76be] h-[9px] sm:h-[10px] rounded-lg w-[280px]  sm:w-96">
                            <div className="sm:h-[8px] h-[6px] w-[150px] bg-[#02C56D] rounded-lg sm:w-72">
                            </div>
                    ...
                    <div className="flex flex-col w-[280px] sm:w-96 mx-auto cursor-pointer my-3">
                        <div className="flex">
                            ...
                            <h1 className="text-[#808dad68] hover:text-white relative left-[70px] sm:left-[230px]">70%</h1>
                        </div>
                        <div className="border-2 border-[#5e76be] h-[9px] sm:h-[10px] rounded-lg w-[280px]  sm:w-96">
                            <div className="sm:h-[8px] h-[6px] w-[120px] bg-[#02C56D] rounded-lg sm:w-72">
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col w-[280px] sm:w-96 mx-auto cursor-pointer my-3">
                        <div className="flex">
                            ...
                            <h1 className="text-[#808dad68] hover:text-white relative left-[60px] sm:left-[230px]">72%</h1>
                        </div>
                        <div className="border-2 border-[#5e76be] h-[9px] sm:h-[10px] rounded-lg w-[280px]  sm:w-96">
                            <div className="sm:h-[8px] h-[6px] w-[125px] bg-[#02C56D] rounded-lg sm:w-72">
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col w-[280px] sm:w-96 mx-auto cursor-pointer my-3">
                        <div className="flex">
                            ...
                            <h1 className="text-[#808dad68] hover:text-white relative left-[10px] sm:left-[230px]">60%</h1>
                        </div>
                        <div className="border-2 border-[#5e76be] h-[9px] sm:h-[10px] rounded-lg w-[280px]  sm:w-96">
                            <div className="sm:h-[8px] h-[6px] w-[100px] bg-[#02C56D] rounded-lg sm:w-72">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <h1 className="text-white text-2xl w-fit mx-auto my-5">Personal Skills</h1>
